...
<link rel="stylesheet" href="./style/1IdFind.css">
<!-- ======================================================== -->
<meta charset="UTF-8">
<title>여기,좋은데 : 아이디 & 비밀번호 찾기 </title>
</head>
<%
		...
		<div class="container-fluid d-inline-flex displayb  ">
			...
			<div class="collapse navbar-collapse  displaye " id="navbarNavDropdown">	
					<ul class="navbar-nav mg-r">
						<%if(sid==null){%>		
							<li class="nav-item mg "><a class="nav-link active b nannum" aria-current="page" href="01_Login.jsp">로그인</a></li>
							<li class="nav-item mg"> <a class="nav-link b nannum" href="01_userInsertForm.jsp">회원가입</a></li>
						<%}else{%>
							<li class="nav-item mg"><a class="nav-link active b nannum" aria-current="page" href="logout">로그아웃</a></li>
							<li class="nav-item dropdown mg-r"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<ul class="dropdown-menu">
									<li><a class="dropdown-item nannum" href="getMyInfo.do">내정보</a></li>
									<li><a class="dropdown-item nannum" href="PaySearch.do">예약 내역</a></li>
									<li><a class="dropdown-item nannum" href="02_jangbaguni.jsp">장바구니</a></li>
									<li><a class="dropdown-item nannum" href="02_jjim.jsp">찜 목록</a></li>
									<li><a class="dropdown-item nannum" href="ReviewSearch.do"> 리뷰</a></li>
								</ul>
							</li>
						<% }%>												
					</ul>
  ...
  <div style="margin: 100px 0px 0px 0px;" >
    <ul class="nav nav-pills mb-3 display" id="pills-tab" role="tablist">
      <li class="nav-item display" role="presentation">
        <a class="nav-link active ftab " id="pills-home-tab" data-bs-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">아이디 찾기</a>
      </li>
      <li class="nav-item" role="presentation">
        <a class="nav-link ftab" id="pills-profile-tab" data-bs-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">비밀 번호 찾기</a>
      </li>
    </ul>

    <div class="tab-content Falign" id="pills-tabContent">
      <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
        <form action="idFind.do" method="post">
          <input class="Ftext  input_phone nannum" type="text" name="ttel" placeholder="전화번호를 기재해주세요."><br>
          <input class="Ftext nannum" type="text" name="email" placeholder="가입시 입력한 이메일을 기재해주세요."><br>
          <input class="Fbox"  type="submit" value="아이디찾기">
        </form>
      </div>
      <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
        <form action="pwChange.do" method="post">
          <input class="Ftext nannum" type="text" name="tid" placeholder="아이디를 기재해주세요."><br>          
           <input class="Ftext input_phone nannum" type="text" name="ttel" placeholder="가입시 입력한 전화번호를  기재해주세요."><br>
           <input class="Ftext nannum" type="text" name="email" placeholder="가입시 입력한 이메일을 기재해주세요."><br>
          <input class="Fbox" type="submit" value="비밀 번호 찾기">
        </form>
      </div>
    </div>
  </div>
