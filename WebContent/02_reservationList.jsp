				...
				<form action="SelectArea.do "class="d-flex" role="search">
					...
					<ul class="navbar-nav">
						<li class="nav-item mg">
							<a class="nav-link active" aria-current="page" href="logout">로그아웃</a></li>
					</ul>
				</div>
				</div>
	...
	<div class="row REcontainer  ">
			...
			<div class="list-group "style="max-width: 350px;" >
   				...
   				<div class="list-group-item list-group-item-action tway1" style="font-size:30px; font-weight:bold;">My Page</div>
       			 ...
       			 <a href="PaySearch.do" class="list-group-item list-group-item-success active" aria-current="true"style="height:60px">예약 내역</a>
		...
		<div class="col-9  displayco  ">
   			 <div class="REform " >
    	   		 <div class="titleRE tway1">Booking List</div>
            ...
            <thead>
    		 ...
    		 <c:otherwise>
            	...
            	<tr style="font-size: 18px; height:10px;">
                	<td scope="col" style=" vertical-align: middle;">${loop.index + 1}</td>
                	<td scope="col" style=" vertical-align: middle;"><img src="./allist/${loop.index + 1}.jpg" class="Rphoto"></td>
                	<td scope="col" id="date" style=" vertical-align: middle;">${vo1.buyer_addr}</td>
               	  	
          		  <c:set var="amountWithoutComma" value="${fn:replace(vo1.amount, ',', '')}" />
           		 <c:set var="amountInt" value="${amountWithoutComma ne '' ? Integer.parseInt(amountWithoutComma) : 0}" />
            
          		  <td scope="col" id="amount" style="vertical-align: middle;">
               
              		  <fmt:formatNumber type="currency" currencyCode="KRW" value="${amountInt}" pattern="###,###원"/>
           		 </td>
            
               		<td scope="col" style=" vertical-align: middle;">
                    <form  action="PayIDSearch.do" style="display: inline-block;">
                        <input type="hidden" name="imp_uid" value="${vo1.imp_uid}">
                        <input type="submit" value="[상세보기]" style="background-color: transparent; color: black; border:none;" >
                    </form>
                	</td>
            </tr>
        </c:forEach>
